...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		style="height:70px;padding:5px;background:url('./images/header_bg.png') no-repeat;background-size:100% 100%">
		<div>
		...
		<div id="sessionInfoDiv"
			...
			<strong>[超级管理员]，欢迎你！</strong>
		</div>
		<div style="position: absolute; right: 15px; bottom: 10px;">
			<a href="javascript:void(0);" class="easyui-menubutton" style="color:black"
		...
		<div id="layout_north_pfMenu" style="width: 120px; display: none;">
			...
			<div onclick="changeTheme('gray');">五十度灰</div>
			<div onclick="changeTheme('black');">超级黑</div>
	...
	<div data-options="region:'center'">
		<div id="tabs" fit="true" class="easyui-tabs" border="false">
			<div title="消息中心" id="subWarp"
				...
				<iframe src="${pageContext.request.contextPath }/base/page_common_home.action"
	...
	<div data-options="region:'south',border:false"
		style="height:30px;padding:5px;background:url('./images/header_bg.png') no-repeat right;">
			...
			<tbody>
				<tr>
					...
					<td style="width: *;text-align:right" class="co1"><span id="online"
						style="background: url(${pageContext.request.contextPath }/images/online.png) no-repeat left;padding-left:18px;margin-right:10px;font-size:11pt;color:black;">在线人数:1</span>
					</td>
				</tr>
			</tbody>
		</table>
